...
Set-ExecutionPolicy Bypass: වින්ඩෝස් පද්ධතියේ ඇති ආරක්ෂක සීමාවන් තාවකාලිකව මඟහැර මෙම ස්ක්‍රිප්ට් එක ධාවනය කිරීමට අවසර ලබා දෙයි.

Tls12 Security Protocol: පැරණි Windows සංස්කරණ වලදී ඇතිවිය හැකි ආරක්ෂිත සබඳතා දෝෂ (SSL/TLS errors) මඟහරවා ගනී.

iwr -useb ... | iex: GitHub හි ඇති setup.ps1 ස්ක්‍රිප්ට් එක පරිගණකයේ තැන්පත් නොකර, කෙලින්ම මතකයෙන් (RAM) ක්‍රියාත්මක කරයි.
...
මෙම Repository එකේ ඇති setup.ps1 ගොනුව බාගත කරගන්න.

PowerShell විවෘත කර එම ගොනුව ඇති ෆෝල්ඩරය වෙත යන්න (cd කමාන්ඩ් එක මඟින්).

පහත කමාන්ඩ්ස් පියවරෙන් පියවර ක්‍රියාත්මක කරන්න:
